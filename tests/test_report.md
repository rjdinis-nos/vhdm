...
| **9** | Status with non-existent mount point (should fail) | <span style="color: green; font-weight: bold;">✓ PASSED</span> |
| **10** | Status with invalid UUID (should fail) | <span style="color: green; font-weight: bold;">✓ PASSED</span> |
